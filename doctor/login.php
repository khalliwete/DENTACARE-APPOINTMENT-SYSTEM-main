...
<head>
	...
	<title>DENTACARE - Doctors Login Page</title>
...
<body class="simple-page">
	...
	<div class="simple-page-wrap">
		<div class="simple-page-logo animated swing">
				...
				<span style="color: white">DENTACARE</span>
			
		</div><!-- logo -->
		<div class="simple-page-form animated flipInY" id="login-form">
	<h4 class="form-title m-b-xl text-center">Sign In With Your DENTACARE Account</h4>
	<h5 class="form-body m-b-xl text-center">This is For Doctors Only!</h5>
