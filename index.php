                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-12 mx-auto">
                            ...
                            <h2 class="text-center mb-lg-3 mb-2" style="color: #1D2A4D;">Book an appointment</h2>
...
<?php }?>
                                        ...
                                        <div class="col-lg-3 col-md-4 col-6 mx-auto">
                                            <button type="submit" class="form-control" name="submit" id="submit-button" style="background-color: #6fd8e7; color: #fff;" onclick="redirectToHome()">Book Now</button>
                                            <script> function redirectToHome() {window.location.href = "index.php";} </script>
                                        </div>
